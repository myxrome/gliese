...
public final class ValueMergeHelper extends BaseMergeHelper {
    ...
    public ValueMergeHelper(Context context, SyncResult syncResult, Uri uri) {
        ...
        nameMapping.put(ApplicationContentContract.Value.CATEGORY_ID, ApplicationServerContract.ValueRecord.CATEGORY_ID);
        nameMapping.put(ApplicationContentContract.Value.NAME, ApplicationServerContract.ValueRecord.NAME);
        nameMapping.put(ApplicationContentContract.Value.REMOTE_THUMB_URI, ApplicationServerContract.ValueRecord.THUMB_REMOTE_URI);
