 ...
 * Time: 23:07
 */
public class CategoryTableHelper extends BaseTableHelper {

    private static final String CREATE_TABLE_SQL = CREATE_TABLE + ApplicationDatabaseContract.CategoryEntry.TABLE_NAME + COLUMNS_BEGIN +
            ...
            FOREIGN_KEY + COLUMNS_BEGIN + ApplicationDatabaseContract.CategoryEntry.TOPIC_ID + COLUMNS_END + REFERENCES +
            ApplicationDatabaseContract.TopicEntry.TABLE_NAME + COLUMNS_BEGIN + ApplicationDatabaseContract.TopicEntry.ID + COLUMNS_END + ON_DELETE_CASCADE +
            COLUMNS_END;

    private static final String CREATE_INDEX_1_SQL = CREATE_INDEX + ApplicationDatabaseContract.CategoryEntry.TABLE_NAME + INDEX_SUFFIX + "1" +
