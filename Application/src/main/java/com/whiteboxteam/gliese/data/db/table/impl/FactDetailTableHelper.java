...
public final class FactDetailTableHelper extends BaseTableHelper {
    ...
    private static final String CREATE_TABLE_SQL = CREATE_TABLE + StatisticDatabaseContract.FactDetailEntry
            ...
            StatisticDatabaseContract.FactDetailEntry.TABLE_NAME + COLUMNS_BEGIN + StatisticDatabaseContract
            .FactEntry.ID + COLUMNS_END + ON_DELETE_CASCADE +
            COLUMNS_END;

    private static final String CREATE_INDEX_1_SQL = CREATE_INDEX + StatisticDatabaseContract.FactDetailEntry
