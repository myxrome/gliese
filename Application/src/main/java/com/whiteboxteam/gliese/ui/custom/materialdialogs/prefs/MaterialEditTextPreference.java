package com.whiteboxteam.gliese.ui.custom.materialdialogs.prefs;
...
import com.whiteboxteam.gliese.ui.custom.materialdialogs.MaterialDialog.Builder;
import com.whiteboxteam.gliese.ui.custom.materialdialogs.MaterialDialog.ButtonCallback;
...
public class MaterialEditTextPreference extends EditTextPreference {
    ...
    protected void showDialog(Bundle state) {
        Builder mBuilder = new MaterialDialog.Builder(getContext()).title(getDialogTitle()).icon(getDialogIcon())
                                                                   .positiveText(getPositiveButtonText())
                                                                   .negativeText(getNegativeButtonText())
                                                                   .callback(callback).content(getDialogMessage());
