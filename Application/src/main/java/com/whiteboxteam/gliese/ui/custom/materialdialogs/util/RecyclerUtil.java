package com.whiteboxteam.gliese.ui.custom.materialdialogs.util;
    ...
    public static boolean canRecyclerViewScroll(View view) {
        ...
        if (lm instanceof LinearLayoutManager) {
            ...
            throw new MaterialDialog.NotImplementedException(
                    "Material Dialogs currently only supports LinearLayoutManager and GridLayoutManager. Please " +
                            "report any new layout managers.");
        }
        ...
        return !lastItemVisible || rv.getChildAt(rv.getChildCount() - 1).getBottom() > rv.getHeight() - rv
                .getPaddingBottom();
    }
