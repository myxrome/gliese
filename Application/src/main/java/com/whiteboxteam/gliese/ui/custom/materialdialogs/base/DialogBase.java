package com.whiteboxteam.gliese.ui.custom.materialdialogs.base;
...
public class DialogBase extends AlertDialog implements DialogInterface.OnShowListener {
    ...
    @Deprecated
    @Override
    public void setView(View view, int viewSpacingLeft, int viewSpacingTop, int viewSpacingRight, int
            viewSpacingBottom) {
        throw new RuntimeException("This method is not supported by the MaterialDialog.");
    }
