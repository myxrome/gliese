...
/**
 * Convenience class for migrating old dialogs code. Not all methods are implemented yet. Using MaterialDialog
 * .Builder directly is recommended.
 */
public class AlertDialogWrapper {
    ...
    public static class Builder {
         ...
         * @param checkedItems specifies which items are checked. It should be null in which case no items are
         *                     checked. If non null it must be exactly the same length as the array of items.
         * @param listener     notified when an item on the list is clicked. The dialog will not be dismissed when an
         *                     item is clicked. It will only be dismissed if clicked on a button, if no buttons are
         *                     supplied it's up to the user to dismiss the dialog.		 * @return
         * @return This
         */
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, @Nullable final boolean[] checkedItems, final
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface
         ...
         * @return This
         */
        public Builder setMultiChoiceItems(@NonNull String[] items, @Nullable final boolean[] checkedItems, final
        DialogInterface.OnMultiChoiceClickListener listener) {
            builder.items(items);
            setUpMultiChoiceCallback(checkedItems, listener);
            return this;
         ...
         * @return This
         */
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface
                .OnClickListener listener) {
            builder.items(items);
