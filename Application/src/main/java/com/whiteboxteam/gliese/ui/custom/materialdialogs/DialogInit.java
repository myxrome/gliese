...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        builder.positiveColor = DialogUtils
                .resolveColor(builder.context, R.attr.md_positive_color, builder.positiveColor);
        ...
        builder.negativeColor = DialogUtils
                .resolveColor(builder.context, R.attr.md_negative_color, builder.negativeColor);
        ...
        if (builder.title == null) {
            ...
            if (builder.titleColorSet) {
                ...
                dialog.title
                        .setTextColor(DialogUtils.resolveColor(dialog.getContext(), R.attr.md_title_color, fallback));
            }
        ...
        if (dialog.content != null) {
            ...
            if (builder.contentColorSet) {
                ...
                final int contentColor = DialogUtils
                        .resolveColor(dialog.getContext(), R.attr.md_content_color, fallback);
        ...
        if (dialog.listView != null && (builder.items != null && builder.items.length > 0 || builder.adapter != null)) {
            ...
            if (builder.title != null) {
                ...
                dialog.listView.setPadding(dialog.listView.getPaddingLeft(), 0, dialog.listView.getPaddingRight(),
                                           dialog.listView.getPaddingBottom());
            }
        ...
        if (builder.customView != null) {
            ...
            if (builder.wrapCustomViewInScroll) {
                ...
                if (innerView instanceof EditText) {
                    ...
                    // Setting padding to scroll view pushes the scroll bars out, don't do it if not necessary (like
                    // above)
    ...
    private static void setupProgressDialog(final MaterialDialog dialog) {
        ...
        if (builder.mIndeterminateProgress || builder.mProgress > -2) {
            ...
            if (builder.title == null) {
                ...
                mainFrame.setPadding(mainFrame.getPaddingLeft(), mainFrame.getPaddingBottom(),
                                     mainFrame.getPaddingRight(), mainFrame.getPaddingBottom());
            }
        }
    }
}